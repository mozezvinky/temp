...
export const user={uid:profile.uid,displayName:profile.displayName,email:profile.email,getIdToken:async()=>"local-ui-fixture"};
export const refreshProfile=async()=>undefined;
export function useAuth(){return {user,profile,refreshProfile,loading:false,homePath:"/dashboard"};}
