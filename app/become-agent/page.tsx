...
export default function BecomeAgentPage() {
  ...
  return <div className="recruitment-page">
    ...
    <Card className="recruitment-opportunity">
      ...
      {rate !== null ? <><h2 className="recruitment-rate mt-3">Earn {(rate * 100).toLocaleString("en-KE", { maximumFractionDigits: 4 })}% commission</h2><p className="mt-3 copic-muted">For eligible KSh 1,000 work, your commission is KSh {(1000 * rate).toLocaleString("en-KE", { maximumFractionDigits: 2 })}.</p><p className="mt-2 text-sm copic-muted">Eligible work only. Income is not guaranteed.</p></> : <p role="status" className="mt-3 copic-muted">{rateError ? "Commission information is temporarily unavailable. Please try again later." : "Loading the current commission…"}</p>}
    </Card>
